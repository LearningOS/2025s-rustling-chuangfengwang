...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        // team_1.
        scores.entry(team_1_name.to_string()).or_insert(Team{goals_scored:0, goals_conceded:0});
        scores.entry(team_2_name.to_string()).or_insert(Team{goals_scored:0, goals_conceded:0});
